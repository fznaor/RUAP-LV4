...
namespace SeleniumTests
{
    ...
    public class Prvi
    {
        ...
        public void ThePrviTest()
        {
            ...
            driver.FindElement(By.Id("input-email")).SendKeys("fznaor@gmail.com");
        ...
        public void TheDrugiTest()
        {
            ...
            driver.FindElement(By.Id("input-firstname")).SendKeys("Fake" + rnd.Next(100));
            driver.FindElement(By.Id("input-lastname")).Click();
            driver.FindElement(By.Id("input-lastname")).Clear();
            driver.FindElement(By.Id("input-lastname")).SendKeys("Name2" + rnd.Next(100));
